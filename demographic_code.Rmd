...
setwd("C:/Users/pscmgo/OneDrive for Business/PhD/Project/Experiment_Code/Straights/Full_Data") # set working directory
...
workingdata <- workingdata %>%
  group_by(trialn) %>%
  mutate(gender = 1, age = 22, licenseTime = 53, contacts_glasses = FALSE, pNum = 10, handedness = 1) %>% # female = 1, male = 2; license time in months; right = 1, left = 2
  ungroup()
