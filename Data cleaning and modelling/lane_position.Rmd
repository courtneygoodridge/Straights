...
ggplot(dat %>%
  ...
  ylim(0, 0.2) +
  theme(axis.title.x = element_text(size = 16), axis.text.x = element_text(size = 16), axis.title.y = element_text(size = 17), axis.text.y = element_text(size = 16), title = element_text(size = 16)) +
