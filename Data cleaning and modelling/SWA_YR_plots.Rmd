...
ggplot(timecoursedata %>%
  ...
  theme_gray() +
  xlab("Time (s)") +
  ylab("Steering wheel angle (degrees)") +
  guides(color = guide_legend(title = "Heading (degrees)")) +
  theme(axis.title.x = element_text(size = 16), axis.text.x = element_text(size = 15), axis.title.y = element_text(size = 15), axis.text.y = element_text(size = 16), title = element_text(size = 12), legend.title = element_text(size = 15), legend.text = element_text(size = 15)) +
...
ggplot(timecoursedata %>%
  ...
  guides(color = guide_legend(title = "Heading (degrees)")) +
  theme(axis.title.x = element_text(size = 16), axis.text.x = element_text(size = 15), axis.title.y = element_text(size = 15), axis.text.y = element_text(size = 16), title = element_text(size = 15), legend.title = element_text(size = 15), legend.text = element_text(size = 15)) +
  geom_vline(aes(xintercept = 2.2, linetype = "Road-line appears")) +
  ggtitle("Steering magnitude over time across conditions") 
