...
ggplot(timecoursedata %>%
  ...
  guides(color = guide_legend(title = "Heading (degrees)")) +
  theme(axis.title.x = element_text(size = 15), axis.text.x = element_text(size = 15), axis.title.y = element_text(size = 15), axis.text.y = element_text(size = 15), title = element_text(size = 15), legend.title = element_text(size = 15), legend.text = element_text(size = 15)) +
  geom_vline(aes(xintercept = 2.2, linetype = "Road-line appears")) +
