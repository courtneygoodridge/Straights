...
trueresponses <- filter(workingdatathresholdUnsmooth, EarlyResponses == FALSE) # filters true threshold responses
...
trueworkingdata <- filter(workingdata, ppid_trialn %in% trueresponses) # filter the IDs in the ID vector
