...
temp = list.files(pattern = c("BenLui17_t4", "*.csv")) # list all CSV files in the directory
...
workingdatathresholdUnsmooth <- workingdatatimecourseUnsmooth %>%
  ...
  mutate(EarlyResponses = abs(FirstSteeringTime - mean(FirstSteeringTime)) < - sd(FirstSteeringTime))
