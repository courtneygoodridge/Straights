...
setwd("C:/Users/pscmgo/OneDrive for Business/PhD/Project/Experiment_Code/Straights/test_example") # set directory for data saving
write.csv(workingdata, file = "BenLui17_18_2.csv") # save the same name but in a different place
...
setwd("C:/Users/pscmgo/OneDrive for Business/PhD/Project/Experiment_Code/Straights/test_example/Full_Data") # set directory for data saving
write.csv(workingdata, file = "BenLui17_18_full.csv")
...
workingdata <- workingdata %>%
  group_by(trialn) %>%
  mutate(gender = 2, age = 22, licenseTime = 8, contacts_glasses = FALSE, pNum = 18, handedness = 1) %>% # female = 1, male = 2; license time in months; right = 1, left = 2
  ungroup()
