...
**Plots**
Error growth against median RTs is possible easy of the two metrics to interpret. Essentially, as error growth increases, median RT decreases. This would be expected, as the faster error develops the faster participants will react to it.
