...
ggplot(dplyr::filter(workingdatathresholdUnsmooth, heading > 0), aes(as.factor(heading), FirstSteeringTime)) +
  ...
  theme(axis.title.x = element_text(size = 16), axis.text.x = element_text(size = 15), axis.title.y = element_text(size = 15), axis.text.y = element_text(size = 16), title = element_text(size = 16), legend.title = element_text(size = 15), legend.text = element_text(size = 15))
