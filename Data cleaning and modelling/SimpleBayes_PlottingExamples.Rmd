...
trials_n <- 270  #number of trials
sigma_y <- 1 # within-participant variability / measurement error

a       <-  0    # average control condition mean
b       <- .5    # average effect size
sigma_a <- 0.12410    # std dev in intercepts (control means, between participant variability)
sigma_b <-  0.04779  # std dev in slopes (effect size)
rho     <- -0.90   # correlation between intercepts and slopes
