...
Despite forcing the code to work, the results from analysing the individual conditions makes intuitive sense for some of the parameters:

**Boundary seperation** doesn't make too much sense. Wabersich & Vandekerckhove (2014) refers to this parameter as a speed-accuracy tradeoff, with higher values relating to higher accuracy.

**Non-decision time** makes sense in this context, as it is similar to the latency value within my theshold model. With regard to both models, the latency should not differ too much as the baseline speeds that humans process information is constant.

A high **initial bias** also makes relative sense. Wabersich & Vandekerckhove (2014) state that an initial bias > 0.5 means bias toward for repsonse "A", which in my case would be the steering respone. 

As heading offset angle increases, the **drift rate** increases. This is what we would expect from an evidence accumulation model interpretation of RT distributions. Something that doesn't make too much sense is a negative drift rate. Wabersich & Vandekerckhove (2014) suggest that drift rates close to zero or under zero represent ambigous stimuli. This makes sense in the context of my experiment, as these conditions contained the most " no steer" trials and thus could be considered the most ambiguous. 
...
When comparing drift rates across conditions, I get results that make sense but still look strange.

**0.5 heading** = -0.80927829 
**1.0 heading** = -0.46197905 
**1.5 heading** = -0.09083249  
**2.0 heading** = 0.02520875

Drift rates increase as heading offset angle increases, however I am still getting negative drift rates...
