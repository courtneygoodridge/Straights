...
workingdata_magResponse_start <- workingdatatimecourseUnsmooth %>% 
...
example <- workingdatatimecourseUnsmooth %>%
select(ppid_trialn, heading, frame, YawRateChange, anchored_timestamp) %>%
group_by(ppid_trialn) %>%
...
merge(example, workingdata_magResponse_start, by.x = "ppid_trialn")

 # %in% might help when I'm combiining peak and response start dataframes 
workingdata_magResponse_start <- workingdata_magResponse_start %>%
